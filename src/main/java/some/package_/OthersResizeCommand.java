...
{
    private final List<String> aliases = Lists.newArrayList(MainClass.ADDON_ID, "basesize", "bs");
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        {
            sender.sendMessage(new TextComponentString(TextFormatting.RED + "Invalid size"));
            return;
        }
        ...
        if(sender instanceof EntityPlayer) MainClass.LOGGER.info(((EntityPlayer) sender).getDisplayNameString() + " set " + player.getDisplayNameString() +"'s size to " + size);
    }
}