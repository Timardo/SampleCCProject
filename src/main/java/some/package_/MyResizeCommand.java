...
{
    private final List<String> aliases = Lists.newArrayList(MainClass.ADDON_ID, "mysize", "ms");
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        if(sender instanceof EntityPlayer)
        {
            ...
            if(sender instanceof EntityPlayer) MainClass.LOGGER.info(((EntityPlayer) sender).getDisplayNameString() + " set their size to " + size);
        }
    }
}