...
public class SampleEventClass {
    ...
    public void onBlockBreak(BreakEvent event) {
        event.getPlayer().sendMessage(new TextComponentString("You've just broken an innocent " + event.getState().getBlock().getLocalizedName()));
    }
    
    // the following code is from GulliverReborn mod
    public static DamageSource causeCrushingDamage(EntityLivingBase entity)
    {
        return new EntityDamageSource(MainClass.ADDON_ID + ".crushing", entity);
    }
    ...
    @SubscribeEvent
    @SideOnly(Side.CLIENT)
    public void onEntityRenderPre(RenderLivingEvent.Pre<EntityLivingBase> event)
    {
