...
public class Config
{
    ...
    {
        MainClass.config = new File(Util.getJarDir() + "/configs/" + MainClass.ADDON_ID);
        MainClass.config.mkdirs();
        init(new File(MainClass.config.getPath(), MainClass.ADDON_ID + ".cfg"));
    }
}